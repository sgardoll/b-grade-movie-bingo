...
abstract class FlutterFlowTheme {
  ...
  late Color cultured;
  late Color cerise;
  late Color tyrianPurple;
  late Color carmine;
  late Color uTOrange;
  late Color spanishOrange;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF154657);
  late Color secondary = const Color(0xFF00BFFF);
  late Color tertiary = const Color(0xFFFFD700);
  late Color alternate = const Color(0xFF181313);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF333333);
  late Color primaryBackground = const Color(0xFFF5F5F5);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF181313);
  late Color accent2 = const Color(0xFF32CD32);
  late Color accent3 = const Color(0xFFFFFF00);
  late Color accent4 = const Color(0xFFFF8C00);
  ...
  late Color peach = Color(0xFFEFC69B);
  late Color amaranthPurple = Color(0xFFAF1B3F);
  late Color englishViolet = Color(0xFF473144);
  late Color khaki = Color(0xFFCCB69B);
  late Color buff = Color(0xFFDF9B6D);
  ...
  late Color tyrianPurple = Color(0xFF5F0F40);
  late Color carmine = Color(0xFF9A031E);
  late Color uTOrange = Color(0xFFFB8B24);
  late Color spanishOrange = Color(0xFFE36414);
  late Color midnightGreen = Color(0xFF0F4C5C);
}
