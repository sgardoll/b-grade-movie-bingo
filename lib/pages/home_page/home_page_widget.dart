                          ...
                          Flexible(
                            ...
                            child: FutureBuilder<List<CardsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CardsRecord> pageViewCardsRecordList =
                                    snapshot.data!;
                                return Container(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                  ...
                                  child: Stack(
                                    children: [
                                      PageView.builder(
                                        ...
                                        itemCount:
                                            pageViewCardsRecordList.length,
                                        itemBuilder: (context, pageViewIndex) {
                                          ...
                                          return wrapWithModel(
                                            model:
                                                _model.gameSwipeModels.getModel(
                                              pageViewCardsRecord.reference.id,
                                              pageViewIndex,
                                            ),
                                            updateCallback: () =>
                                                setState(() {}),
                                            ...
                                            child: GameSwipeWidget(
                                              key: Key(
                                                'Keyk8s_${pageViewCardsRecord.reference.id}',
                                              ),
                                              color: pageViewCardsRecord.color!,
                                              image: pageViewCardsRecord.image,
                                              icon: Icon(
                                                Icons.movie_filter,
                                                size: 24.0,
                                              ),
                                              gameRef:
                                                  pageViewCardsRecord.reference,
                                            ),
                                          );
                                        },
                                      ),
                                              ...
                                              PageController(
                                                  initialPage: min(
                                                      ...
                                                      pageViewCardsRecordList
                                                              .length -
                                                          1)),
                                          count: pageViewCardsRecordList.length,
